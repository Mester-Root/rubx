...
class UserMethods:
    ...
    def get_user(self) -> typing.Union[str, dict]:
        ...
        return GetData.pwa(api_version='2', platform=clients.mrubika, session=self.auth, method='getUser', api='https://messengerg2c1.iranlms.ir')
    ...
    def search_query(self, search_input: str, tag_id: str = 'search', /,
        ...
        return GetData.pwa(platform=clients.mrubika, session=self.auth, data=data, method='searchQuery', api='https://namavact.iranlms.ir')
    ...
    def get_search_structure(self) -> typing.Union[str, dict, object]:
        ...
        return GetData.pwa(platform=clients.mrubika, session=self.auth, method='getSearchStructure', api='https://services3.iranlms.ir/')
    ...
    def get_endpoint_view(self, endpoint_type_id: str) -> typing.Union[str, dict, object]:
        ...
        return GetData.pwa(platform=clients.mrubika, session=self.auth, method='getEndpointView', api='https://services3.iranlms.ir/')
    ...
    def get_endpoint_data(self, object_id: str) -> typing.Union[str, dict, object]:
        ...
        return GetData.pwa(platform=clients.mrubika, session=self.auth, method='getEndpointData', api='https://services2.iranlms.ir/')
    ...
    def get_barcode_action(self, barcode: str,
        ...
        return GetData.pwa(platform=clients.mrubika, session=self.auth, method='getBarcodeAction', api='https://barcode4.iranlms.ir/')
    ...
    def get_tag_list(self,
        ...
        return GetData.pwa(platform=clients.mrubika, session=self.auth, method='getTagList', data={'taglist_id': taglist_id}, api='https://services3.iranlms.ir/')
    ...
    def get_tag_objects(self, tag_id: str = 'top_banner', limit: int = 20,
        ...
        return GetData.pwa(platform=clients.mrubika, session=self.auth, method='getTagObjects', data=data, api='https://services.iranlms.ir/')
