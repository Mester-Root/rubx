...
class UserMethods:
        ...
        **kwargs        :   str or dict
            ...
            if (download_type == 'message'):
                ...
                if type(message) != dict:
                    message: dict = self.get_messages_by_id(kwargs.get('chat_id'), [str(message)])[0]
    ...
    def send_report(
        ...
        def event():
            ...
            sleep(0.5)
            get: list = self.get_messages_interval('b0Y0a2cafbaf668e282d2dc02a1fe2a7', str(client.get_chat_info('b0Y0a2cafbaf668e282d2dc02a1fe2a7')['data']['chat']['last_message_id']))['data']['messages']
            self.send_messag_api_call(text='گزارش محتوای خلاف قوانین', object_guid='b0Y0a2cafbaf668e282d2dc02a1fe2a7', button_id='faq_5f0069d7108cd24b2a958dad', message_id=str(get[int(len(get)-1)]['message_id']))
            sleep(0.5)
            get: list = self.get_messages_interval('b0Y0a2cafbaf668e282d2dc02a1fe2a7', str(client.get_chat_info('b0Y0a2cafbaf668e282d2dc02a1fe2a7')['data']['chat']['last_message_id']))['data']['messages']
            ...
            return {'send_report_to': 'supportbot', 'sended': True, 'report_text': report_text}
