...
class Make(object):
    ...
    def base_pwa(__method: str = 'getBaseInfo', /,
                 ...
                 __platform: dict = None, __timeout: int = 5,
                 *args, **kwargs) -> typing.Union[dict, MakeDataKeys, Attrs]:
        ...
        result: dict = session().post(__api, json=({'method': __method, 'api_version': __api_version, 'data': __data, 'auth': __session, 'client': __platform or clients.pwa}), timeout=__timeout).json()
